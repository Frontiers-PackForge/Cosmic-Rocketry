package com.ghostipedia.cosmicrocketry.client.models.entities;
...
public class CosmicRocketModel<T extends CosmicRocket> extends RocketModel<T> {
    public static final ModelLayerLocation TIER_5_LAYER = new ModelLayerLocation(new ResourceLocation(CosmicRocketry.MOD_ID, "tier_5_rocket"), "main");
    public static final ModelLayerLocation TIER_6_LAYER = new ModelLayerLocation(new ResourceLocation(CosmicRocketry.MOD_ID, "tier_5_rocket"), "main");
    public static final ModelLayerLocation TIER_7_LAYER = new ModelLayerLocation(new ResourceLocation(CosmicRocketry.MOD_ID, "tier_5_rocket"), "main");

    public CosmicRocketModel(ModelPart root) {
        super(root);
    }
    ...
    public static void register(ClientPlatformUtils.LayerDefinitionRegistry registry) {
        registry.register(TIER_5_LAYER, CosmicRocketModel::createTier5Layer);
        registry.register(TIER_6_LAYER, CosmicRocketModel::createTier6Layer);
        registry.register(TIER_7_LAYER, CosmicRocketModel::createTier7Layer);
    }
}
